...
def main():
    ...
    target_modules = {k: named_modules[k] for k in named_modules if 
                isinstance(named_modules[k], Linear)
               or isinstance(named_modules[k], Conv2d)
               or isinstance(named_modules[k], Embedding)
    }
    # target_modules = [
    #     # 'time_embed.2',
    #     # 'time_embed.2'
    #     # 'ouput_blocks.3.0.out_layers.3'
    ...
    # model = inject_adapter_in_model(unet_lora_config, model)
    ...
    #         if name in [
    #             'base_model.model.output_blocks.15.0.skip_connection.base_layer.weight',
    #             'base_model.model.output_blocks.15.0.skip_connection.base_layer.bias',
    #         ]:
    #             print('*'*50)
